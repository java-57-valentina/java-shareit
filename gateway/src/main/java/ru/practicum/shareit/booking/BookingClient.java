...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> add(Long userId, BookingRequestDto bookingDto) {
    ...
    public ResponseEntity<Object> findByState(Long userId, State state) {
    ...
    public ResponseEntity<Object> findByOwner(Long ownerId, State state) {
        Map<String, Object> parameters = Map.of("state", state.name());
